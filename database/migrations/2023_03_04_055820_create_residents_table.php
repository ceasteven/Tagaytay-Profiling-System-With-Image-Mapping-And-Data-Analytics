...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('residents', function (Blueprint $table) {
            ...
            $table->integer('housemembernum')->nullable();
            ...
            $table->integer('trainnum')->nullable();
            ...
            $table->integer('employhrs')->nullable();
            $table->integer('employthrs')->nullable();
            ...
            $table->integer('findworknum')->nullable();
            ...
            $table->integer('cashsalary')->nullable();
            $table->integer('kindsalary')->nullable();
