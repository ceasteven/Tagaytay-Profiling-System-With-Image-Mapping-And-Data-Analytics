                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <p class="col-sm-6 col-form-label">117. What is the tenure status of the agriculture land being tilled by the
                                        household?</p>
                                    <div class="col-sm-5">
                                        <select class="form-control" name="tenurestatus" id="tenurestatus" disabled="disabled">
                                            <option value="">Select</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control" name="livingnum" id="livingnum" disabled="disabled">
                                            <option value="">Select</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control" name="waterr" id="waterr" disabled="disabled">
                                            <option value="">Select</option>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="quakesrc" id="quakesrc" disabled="disabled">
                                            <option value="">Select</option>
                                            <option value="National government">National government</option>
                                            <option value="Local governmen">Local government</option>
                                            <option value="Non-government organization3">Non-government organization</option>
                                    ...
                                    <div class="col-sm-2">
                                        <input name="eruptnum" class="form-control input-sm" id="eruptnum" type="number" disabled="disabled" placeholder="" />
                                        </select>
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input name="othr" class="form-control input-sm" type="text" min="0" placeholder="" id="othr" disabled="disabled" />
                                    </div>
                                    <div class="col-sm-5">
                                        <input name="othrnum" class="form-control input-sm" type="number" min="0" placeholder="" id="othrnum" disabled="disabled" />
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="col-sm-5 col-form-label"></p>
