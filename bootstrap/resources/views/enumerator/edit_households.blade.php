                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="fishoneown" class="form-control input-sm" type="number" min="0" placeholder="" id="fishonwown" value="{{$household->fishtwo}}" />
                                    </div>
                                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="ffwname" class="form-control input-sm" type="text" placeholder="" id="ffwname" value="{{$household->ffwnam}}" />
                                        <br>
                                    </div>
                                    ...
                                    <div class="col-sm-5">
                                        <input name="pensionaname" class="form-control input-sm" type="text" placeholder="" id="pensionname" value="{{$household->pensionname}}" />
                                    </div>
                                    ...
                                    <div class="col-sm-5">
                                        <input name="housingname" class="form-control input-sm" type="text" placeholder="" id="housingname" value="{{$household->houseingname}}" />
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group row">
                                    <p class="col-sm-4 col-form-label">
                                        <medium>184. How many household members are covered by or are members of this
                                            program?</medium>
                                    </p>
                                    <p class="col-sm-4 col-form-label">
                                        <medium>185. What are the names of the household members who are beneficiaries
                                            /members of the program? </medium>
                                    </p>
                                    <p class="col-sm-3 col-form-label">
                                        <medium>186. Who implemented this program?</medium>
                                    </p>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="memoi" id="memoi">
                                            ...
                                            <option value="Private Organizations or NGOs" {{$household->memoi == 'Private Organizations or NGOs' ? 'selected':'' }}>Private Organizations/NGOs</option>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="memtwpi" id="memtwpi">
                                            ...
                                            <option value="Private Organizations or NGOs" {{$household->memtwpi == 'Private Organizations or NGOs' ? 'selected':'' }}>Private Organizations/NGOs</option>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="memthpi" id="memthpi">
                                            ...
                                            <option value="Private Organizations or NGOs" {{$household->memthpi == 'Private Organizations or NGOs' ? 'selected':'' }}>Private Organizations/NGOs</option>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="memfpi" id="memfpi">
                                            ...
                                            <option value="Private Organizations or NGOs" {{$household->memfpi == 'Private Organizations or NGOs' ? 'selected':'' }}>Private Organizations/NGOs</option>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="memepi" id="memepi">
                                            ...
                                            <option value="City or Municipality" {{$household->memmemepisixtepi == 'City or Municipality' ? 'selected':'' }}>City/Municipality</option>
                                    ...
                                    <div class="col-sm-3">
                                        <input name="memthr" class="form-control input-sm" type="number" placeholder="" id="memthr" value="{{$household->methr}}" />
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <input name="memfourp" class="form-control input-sm" type="text" placeholder="" id="memfourp" value="{{$household->memfoup}}" />
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control" name="memfourpi" id="memfourpi">
                                            <option value="" {{$household->memfourpi == '' ? 'selected':'' }}>Select</option>
                                            <option value="National" {{$household->memfourpi == 'National' ? 'selected':'' }}>National</option>
                                            <option value="Province" {{$household->memfourpi == 'Province' ? 'selected':'' }}>Province</option>
                                            <option value="City or Municipality" {{$household->memfourpi == 'City or Municipality' ? 'selected':'' }}>City/Municipality</option>
                                            <option value="Barangay" {{$household->memfourpi == 'Barangay' ? 'selected':'' }}>Barangay</option>
                                            <option value="Congress or District" {{$household->memfourpi == 'Congress or District' ? 'selected':'' }}>Congress/District</option>
                                            <option value="Private Organizations or NGO" {{$household->memfourpi == 'Private Organizations or NGO' ? 'selected':'' }}>Private Organizations/NGOs</option>
                                            <option value="Dont know" {{$household->memfourpi == 'Dont know' ? 'selected':'' }}>Don't know</option>
                                            <option value="Others" {{$household->memfourpi == 'Others' ? 'selected':'' }}>Others</option>
                                        </select>
                                        <br>
                                    </div>
                                    <div class="col-sm-3">
