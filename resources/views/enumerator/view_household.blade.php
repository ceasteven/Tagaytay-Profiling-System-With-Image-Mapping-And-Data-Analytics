                                ...
                                <div class="tab">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <h6><strong>M.1. ENTREPRENEURIAL ACTIVITIES/SUSTENANCE ACTIVITIES</strong></h6>
                                            ...
                                            <div class="form-group row">
                                                <p class="col-sm-6 col-form-label text-center"></p>
                                                <p class="col-sm-6 col-form-label text-center"></p>
                                                <p class="col-sm-6 col-form-label text-center"></p>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input name="boatthree" class="form-control input-sm" type="number" min="0" placeholder="" id="boatthree" value="{{$household->boatthree}}" />
                                                </div>
                                                <div class="col-sm-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <select class="form-control" name="fishysrc" id="fishyrsc">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <p class="col-sm-2 col-form-label">6 Landslide/mudslide</p>
                                                <div class="col-sm-2">
