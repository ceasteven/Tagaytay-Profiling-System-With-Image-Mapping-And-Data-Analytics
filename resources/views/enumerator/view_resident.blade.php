                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="residingo" name="residingo" style='display:none' />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-5 col-form-label">Other address</label>
                                    <div class="col-sm-6">
                                        <input type="text" id="residingo" name="residingo" value="{{$residents->residingo == 'residingo' ? 'selected':'' }}" />
