...
use App\Http\Middleware\SetSessionTimeout;
...
| routes are loaded by the RouteServiceProvider within a group whichp
...
// Define a new middleware group
    ...
    Route::get('/password/reset', [ForgotPasswordController::class, 'showLinkRequestForm'])->name('password.request')->middleware(['setSessionTimeout']);
    Route::post('/password/reset', [ResetPasswordController::class, 'reset'])->name('password.update');
    Route::get('/password/reset/{token}', [ResetPasswordController::class, 'showResetForm'])->name('password.reset')->middleware(['setSessionTimeout']);
